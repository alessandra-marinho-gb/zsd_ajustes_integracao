class ZCL_ZGWSD_ENVIO_NFERAB_MPC_EXT definition
  public
  inheriting from ZCL_ZGWSD_ENVIO_NFERAB_MPC
  create public .
...
CLASS ZCL_ZGWSD_ENVIO_NFERAB_MPC_EXT IMPLEMENTATION.
...
METHOD add_action.
  ...
  TRY .
      ...
      lo_action->set_return_entity_type( 'ZI_NFeRabbitMQType' ) .
      lo_action->set_return_entity_set( 'ZI_NFeRabbitMQ' ).
  ...
  TRY .
      ...
      DATA(lo_parameter) = lo_action->create_input_parameter(
                                    iv_parameter_name = 'Documento'
                                    iv_abap_fieldname = 'DOCUMENTO' ).
...
*  CONCATENATE 'IsActive' iv_action_name INTO DATA(lv_action_ac).
  ...
  TRY .
      ...
      lo_annotation->add( iv_key = 'action-for' iv_value = 'ZI_NFeRabbitMQType' ).
