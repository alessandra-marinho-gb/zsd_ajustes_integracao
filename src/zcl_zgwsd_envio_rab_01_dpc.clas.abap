class ZCL_ZGWSD_ENVIO_RAB_01_DPC definition
  public
...
protected section.
  ...
  methods ZI_NFERABBITMQ_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZGWSD_ENVIO_RAB_01_MPC=>TS_ZI_NFERABBITMQTYPE
    raising
  ...
  methods ZI_NFERABBITMQ_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZGWSD_ENVIO_RAB_01_MPC=>TT_ZI_NFERABBITMQTYPE
...
CLASS ZCL_ZGWSD_ENVIO_RAB_01_DPC IMPLEMENTATION.
...
*&* This class has been generated on 07.02.2022 17:10:55 in client 500
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZGWSD_ENVIO_RAB_01_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA zi_nferabbitmq_create_entity TYPE zcl_zgwsd_envio_rab_01_mpc=>ts_zi_nferabbitmqtype.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA zi_nferabbitmq_get_entity TYPE zcl_zgwsd_envio_rab_01_mpc=>ts_zi_nferabbitmqtype.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZGWSD_ENVIO_RAB_01_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA zi_nferabbitmq_get_entityset TYPE zcl_zgwsd_envio_rab_01_mpc=>tt_zi_nferabbitmqtype.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA zi_nferabbitmq_update_entity TYPE zcl_zgwsd_envio_rab_01_mpc=>ts_zi_nferabbitmqtype.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    ...
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = 20220207201054
               iv_uuid              = 'ZGWSD_ENVIO_RABBITMQ'
